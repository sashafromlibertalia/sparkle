...
reg5[13] = new RegExp(/армею/i)
reg5[14] = new RegExp(/армеей/i)
reg5[15] = new RegExp(/ормейка/i)
reg5[16] = new RegExp(/ормейки/i)
reg5[17] = new reg2(/ормейку/i)
reg5[18] = new RegExp(/ввс/i)
reg5[19] = new RegExp(/вск/i)
reg5[20] = new RegExp(/дезертир/i)
reg5[21] = new RegExp(/дезертиры/i)
reg5[22] = new RegExp(/дезертира/i)
reg5[23] = new RegExp(/дезертиров/i)
reg5[24] = new RegExp(/служба/i)
reg5[25] = new RegExp(/службы/i)
