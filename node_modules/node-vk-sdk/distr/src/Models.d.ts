...
export declare type AccountNameRequestStatus = string;
...
export declare type AccountOnoffOptions = string;
...
export declare type AccountPushParamsMode = string;
export declare type AccountPushParamsSettings = string;
...
export declare type AdsAccessRole = string;
...
export declare type AdsAccountType = string;
...
export declare type AdsAdCostType = number;
export declare type AdsAdStatus = number;
export declare type AdsAdApproved = number;
...
export declare type AdsAdLayoutCostType = number;
...
export declare type AdsCampaignType = string;
export declare type AdsCampaignStatus = number;
...
export declare type AdsCriteriaSex = number;
...
export declare type AdsObjectType = string;
...
export declare type AdsStatsSexValue = string;
...
export declare type AdsTargSuggestionsSchoolsType = string;
...
export declare type AppsAppType = string;
export declare type AppsAppLeaderboardType = number;
...
export declare type BaseBoolInt = number;
...
export declare type BaseLinkButtonActionType = string;
...
export declare type BaseOkResponse = number;
...
export declare type BasePropertyExists = number;
...
export declare type BaseSex = number;
export declare type BoardDefaultOrder = number;
...
export declare type FriendsFriendStatusStatus = number;
...
export declare type GiftsGiftPrivacy = number;
...
export declare type GroupsBanInfoReason = number;
...
export declare type GroupsGroupIsClosed = number;
export declare type GroupsGroupType = string;
export declare type GroupsGroupAdminLevel = number;
...
export declare type GroupsGroupFullMemberStatus = number;
export declare type GroupsGroupFullMainSection = number;
export declare type GroupsGroupFullAgeLimits = number;
...
export declare type GroupsGroupXtrInvitedByType = string;
export declare type GroupsGroupXtrInvitedByAdminLevel = number;
...
export declare type GroupsMemberRoleStatus = string;
...
export declare type GroupsOwnerXtrBanInfoType = string;
...
export declare type GroupsRoleOptions = string;
...
export declare type LeadsCheckedResult = string;
...
export declare type MarketMarketItemAvailability = number;
...
export declare type MessagesHistoryMessageAttachmentType = string;
...
export declare type MessagesMessageAttachmentType = string;
...
export declare type MessagesMessageActionStatus = string;
...
export declare type MessagesChatSettingsState = string;
...
export declare type NewsfeedNewsfeedItemType = string;
...
export declare type NewsfeedItemWallpostType = string;
...
export declare type PagesPrivacySettings = number;
...
export declare type PhotosImageType = string;
...
export declare type PhotosPhotoSizesType = string;
...
export declare type SearchHintType = string;
export declare type SearchHintSection = string;
...
export declare type StoriesStoryStatsState = string;
...
export declare type StoriesStoryType = string;
...
export declare type UtilsDomainResolvedType = string;
...
export declare type UtilsLinkCheckedStatus = string;
...
export declare type UsersUserType = string;
...
export declare type VideoCatBlockView = string;
...
export declare type VideoCatElementType = string;
...
export declare type WallCommentAttachmentType = string;
...
export declare type WallPostSourceType = string;
...
export declare type WallPostType = string;
...
export declare type WallWallpostAttachmentType = string;
...
export declare type WidgetsCommentMediaType = string;
