...
request(url, async function(error, res, body) {
	...
	let Subject = new RegExp(context.$match[1],'i');
	let homeWork = context.$match[2];
	let subjects = [];
	$('td').each(function(i) {
...
let rozhi = new Array(4) //Любое число
rozhi[0] = 'PHOTO_ID'
rozhi[1] = 'PHOTO_ID'
rozhi[2] = 'PHOTO_ID'
rozhi[3] = 'PHOTO_ID'
